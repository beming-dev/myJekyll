...
category: about블로그
thumbnail: Blog.png
tags: [blog, jekyll, html, css, github pages]
---
...
원래 나는 Jekyll의 collection 기능을 이용해 categorizing을 했었다. collection을 간단히 설명하자면, 루트 디렉토리에 "\__collection_name_ " 폴터를 만들고, 그 아래에 마크다운 파일을 만들면, 프로젝트 내에서 site.*collction_name*으로 접근할 수 있게 해주는 기능이다. 이 과정에서 \_config.yml 파일에
...
카테고리에 포함된 글 개수도 쉽게 불러올 수 있고, 사용되지 않는 카테고리는 site.categories에 포함되지 않기 때문에 보여지지 않아서 매우 좋은 방법이다.
...
<div style="display:flex; justify-content:space-evenly; align-items:center; background:antiquewhite; width:100%; max-width:800px;">
    <img src="/assets/images/2021-03-25-블로그 업데이트/1.jpg" alt="KakaoTalk_20210325_154200702" style="width:40%; max-width: 250px;" />(전)
    <img src="/assets/images/2021-03-25-블로그 업데이트/2.jpg" alt="KakaoTalk_20210325_154200702" style="width:40%; max-width: 250px;" />(후)
</div>
...
<img src="/assets/images/2021-03-25-블로그 업데이트/3.png" alt="화면 캡처 2021-03-25 154642"/>
